...
// --- IMPORTS (Apenas Spaces) ---
const multer = require('multer');
const { S3Client } = require('@aws-sdk/client-s3');
const multerS3 = require('multer-s3-v2');
// const mercadopago = require('mercadopago'); // REMOVIDO
...
app.use(express.json()); // Essencial para o Inbound
...
// ===================================================================
// --- CONFIGURAÇÃO: DIGITALOCEAN SPACES (UPLOAD) ---
// ===================================================================
...
// ===================================================================
// --- CONFIGURAÇÃO DO MERCADO PAGO --- (REMOVIDO)
// ===================================================================
...
// --- ROTA DE SAÚDE ---
app.get('/', (req, res) => {
  // Mensagem atualizada sem Mercado Pago
  res.send('API v3.0 | Módulos: Kommo, Notion, MetaCAPI, Admin, Spaces Upload. 🚀');
});
...
// --- ROTA PÚBLICA DE PAGAMENTO (MERCADO PAGO) --- (REMOVIDO)
/* TODA A ROTA app.post('/processar-pagamento', ...) FOI REMOVIDA DAQUI.
*/
